...
//            val intentToTemp = Intent(this, TempActivity::class.java)
//            intentToTemp.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
//            startActivity(intentToTemp)
//        }
////        binding.QuoteText.setMovementMethod(ScrollingMovementMethod.getInstance());
//
